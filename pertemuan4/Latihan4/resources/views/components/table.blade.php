...
<div class="bg-neutral-primary-soft shadow-xs rounded-base border border-default overflow-hidden">
    ...
    {{-- 1. HEADER: Pencarian dan Tombol Add Post (Dari Gambar 1) --}}
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center gap-4 bg-gradient-to-r from-blue-50 to-indigo-50">
        ...
        <form method="GET" action="{{ route('dashboard.index') }}" class="flex-1 max-w-md">
            ...
            <div class="relative">
                ...
                <button type="submit" class="absolute end-1.5 bottom-1.5 text-white bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded text-xs px-3 py-1.5 focus:outline-none">
                    Search
                </button>
            </div>
        </form>
    ...
    {{-- 2. TABEL KONTEN (Dari Teks Anda) --}}
    <div class="relative overflow-x-auto">
        <table class="w-full text-sm text-left rtl:text-right text-body">
            <thead class="text-xs text-body bg-neutral-secondary-soft border-b rounded-base border-default">
                <tr>
            ...
            <tbody>
                @forelse($posts as $post)
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <img id="preview" class="w-32 h-32 rounded-base object-cover border border-default bg-gray-100"
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-12 py-12 text-center text-gray-500">
                            No posts yet.
